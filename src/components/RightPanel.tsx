...
import { addJoin, reset, removeJoin, setOrderBy } from "../store/querySlice";
...
export const RightPanel: React.FC = () => {
	...
	return (
		<div style={styles.rightPanel}>
			...
			{/* ORDER BY Section */}
			<div style={styles.panelSection}>
				<h3 style={styles.panelH3}>Order By</h3>
				...
				<div style={styles.formGroup}>
					...
					>
						...
						{/* use available columns from nodes */}
						{state.nodes
							.flatMap((n) => n.columns)
							.map((col, i) => (
				...
				<div style={styles.formGroup}>
					...
					<select
						...
						style={styles.select}
					>
						<option value="ASC">ASC (A → Z / Small → Big)</option>
						<option value="DESC">DESC (Z → A / Big → Small)</option>
					</select>
				</div>

				<button onClick={handleAddOrderBy} style={styles.btnPrimary}>
					Add Order By
				</button>
